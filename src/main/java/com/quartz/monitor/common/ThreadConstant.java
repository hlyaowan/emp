...
public class ThreadConstant {
    ...
    public final static int CATALOGLIST_THREAD = 2;
    public final static int CHANNELS_THREAD = 3;
    ...
    public final static int RECOMMEND_THREAD = 1;
    public final static int RECOMMENDTYPE_THREAD = 1;
    public final static int IDENTIFYCNET_THREAD = 10;
}
